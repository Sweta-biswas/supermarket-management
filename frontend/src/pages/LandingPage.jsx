...
function LandingPage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-r from-yellow-500 to-yellow-100 p-4">
      ...
      <div className="w-full max-w-full mx-auto mt-8 bg-white shadow-lg rounded-lg overflow-hidden" style={{ height: '550px' }}>
...
<div className="w-full max-w-6xl mx-auto mt-12 bg-white shadow-lg rounded-lg overflow-hidden">
  <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center p-4">Benefits of EasyBill Supermarket Management System</h2>
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 p-4">
    ...
    <div className="flex flex-col items-center text-center p-4">
      ...
      <p className="text-gray-600">Efficiently manage staff schedules, roles, and performance to optimize workforce productivity.</p>
       ...
       <div className="w-full max-w-6xl mx-auto mt-16 bg-white shadow-lg rounded-lg overflow-hidden">
        <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center p-4">Awards and Accomplishments</h2>
    ...
    <div className="w-full max-w-6xl mx-auto mt-16 bg-white shadow-lg rounded-lg overflow-hidden">
      <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center p-4">What is EasyBill Supermarket Management System?</h2>
      <p className="text-lg text-gray-700 mb-6 p-4">
      ...
      <div className="w-full max-w-6xl mx-auto mt-16 bg-white shadow-lg rounded-lg overflow-hidden">
        <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center p-4">What are the benefits of EasyBill Supermarket Management System?</h2>
      ...
      <div className="w-full max-w-6xl mx-auto mt-16 bg-white shadow-lg rounded-lg overflow-hidden">
        <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center p-4">What are the key features of EasyBill Supermarket Management System?</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-4">
          <div className="flex items-start">
            <div className="mr-4 text-red-500">
      ...
      <div className="w-full max-w-6xl mx-auto mt-16 bg-white shadow-lg rounded-lg overflow-hidden">
        <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center p-4">Why is EasyBill the best Supermarket Management System?</h2>
        <p className="text-lg text-gray-700 mb-6 p-4">
      ...
      {/* Integrated Management Section */}
        <div className="w-full max-w-6xl mx-auto mt-16 bg-white shadow-lg rounded-lg overflow-hidden">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center p-4">

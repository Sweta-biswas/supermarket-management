...
function ProductManagerSignIn() {
  ...
  const handleSignIn = (e) => {
    ...
    const fixedManagerUsername = 'Manager';
    const fixedManagerPassword = 'manager@123';

    if (username === fixedManagerUsername && password === fixedManagerPassword) {
      toast.success("Sign in successful!");
      localStorage.setItem('login','manager')
      setTimeout(() => {
...
export default ProductManagerSignIn;